...
class SearchPage extends SearchDelegate {
  ...
  playSongFromAlbumItem(String albumId) async {
    int index = 0;
  ...
  playSong(List<SongInfo> songs, int index) async {
  ...
  Widget buildLeading(BuildContext context) {
    searchFuture = searchAppForSong(query, context);
    return IconButton(
  ...
  Widget buildResults(BuildContext context) {
    return  totalSearchedItem();
  }

  Widget totalSearchedItem()  {
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) => GestureDetector(
                ...
                child: AlbumItem(
                  ...
                  item: albums[index],
                  onPressed: () {
                    playSongFromAlbumItem(albums[index].id);
                  },
                ),
              ),
            ),
